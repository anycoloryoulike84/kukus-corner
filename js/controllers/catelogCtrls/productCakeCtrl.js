	...
	//RATINGS
	  ...
	  app.controller('productCakeCtrl', ['$scope','$http', 'ngCart', 'cakeService', function($scope, $http, ngCart, cakeService) {

		
		  //QUANTITY COUNTER
		  /*cakeService.setData("a");
		  console.log(cakeService.getData());*/
	  ...
	  $http.get('data/datafile.json').success(function(data, status, headers, config) {
    	  ...
    	  $scope.productCakes = data.items.Cakes;
    		
    	  cakeService.setData($scope.productCakes);
       });
