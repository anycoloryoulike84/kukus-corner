	...
	//RATINGS
	  ...
	  app.controller('productToyCtrl', ['$scope','$http', 'ngCart', 'cakeService', function($scope, $http, ngCart, cakeService) {
	  ...
	  $http.get('data/datafile.json').success(function(data, status, headers, config) {
	    		...
	    		$scope.productToys = data.items.Toys;
	    		
	    		console.log("test");
	    		
	    		cakeService.setData($scope.productToys);
